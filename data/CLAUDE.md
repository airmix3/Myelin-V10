# Myelin v10 Agent Workspace

This is the agent execution environment for Myelin v10 — The Cortex.
...
- Use MCP tools (mcp__myelin__*) for company operations (memory, knowledge, deliverables, escalations, etc.)
