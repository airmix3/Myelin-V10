...
| [14 - COMPANY.md System](docs/14_COMPANY_MD_SYSTEM.md) | Bounded company-state memory for Tamir and the company refresh pipeline |
| [15 - Memory System](docs/15_MEMORY_SYSTEM.md) | Persistent memory layers for Tamir, department heads, knowledge, and assets |
| [16 - UI Migration Plan](docs/16_UI_MIGRATION_PLAN.md) | UI migration notes and implementation sequencing for newer Cortex surfaces |
| [17 - Hiring Delegation](docs/17_HIRING_DELEGATION.md) | Temporary employees, parallel delegation, and approval flows for extra capacity |
| [18 - Strategic Layer](docs/18_STRATEGIC_LAYER.md) | Canvas-chats, directions, goals, seeds, and the CEO's strategic thinking space |
| [19 - Company Onboarding](docs/19_COMPANY_ONBOARDING.md) | Dynamic company creation, persona capture, and generated department structures |
| [20 - Command Layer Requirements](docs/20_COMMAND_LAYER_IMPLEMENTATION.md) | Concept-to-capability bridge for turning Cortex into a live command surface with situations, campaigns, fog-of-war, and skill progression |
| [21 - Executive Assistant](docs/21_EXECUTIVE_ASSISTANT.md) | Tamir's second mode for CEO-space management, The Three, CEO Missions, decision logs, proactive outreach, and connected inbox signals |
| [22 - Executive Assistant System Requirements](docs/22_EXECUTIVE_ASSISTANT_SYSTEM_SPEC.md) | Concrete implementation spec for CEO Space primitives, Attention Shield policy, privacy boundaries, workflows, APIs, and MVP phases |
