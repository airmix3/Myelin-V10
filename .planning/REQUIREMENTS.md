...
- [ ] **FOUND-01**: Next.js 14 App Router project initialized with TypeScript strict mode and pnpm
- [ ] **FOUND-02**: Prisma 7.5 + SQLite with WAL mode (`PRAGMA journal_mode=WAL`, `PRAGMA busy_timeout=5000`), zod v4 (NOT v3 — hard SDK peer dependency)
...
- [ ] **FOUND-09**: ID generation utility: `generateId(prefix)` → `${prefix}_${randomBytes(4).hex}` (e.g., `task_a1b2c3d4`)
