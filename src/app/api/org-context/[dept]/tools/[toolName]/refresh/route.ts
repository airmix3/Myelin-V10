...
export async function POST(
  ...
  try {
    ...
    await invokeAgent({
      ...
      agentId: 'tamir',
      department: 'cos',
      prompt: `Follow your skill-tool-manager skill. Refresh tool: ${toolName} in directory data/departments/${dept}/tools/. Department: ${dept}.`,
    ...
    return NextResponse.json({ success: true, message: `Tool ${toolName} refresh started` });
  } catch (err) {
